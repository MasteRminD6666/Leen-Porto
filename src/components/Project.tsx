    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                    ...
                    <a href="" target="_blank" rel="noreferrer"><h2>Secure Network Implementation with Firewall and Access Control (Cisco Packet Tracer)</h2></a>
            ...
            <div className="project">
                    ...
                    <a href="" target="_blank" rel="noreferrer"><h2>Dynamic Routing Network using OSPF (Cisco Packet Tracer)</h2></a>
