    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                    <a href="#" target="_blank" rel="noreferrer" aria-label="Secure Network Implementation Project"><img src={mock12} className="zoom" alt="thumbnail" width="100%"/></a>
                    <a href="#" target="_blank" rel="noreferrer" aria-label="Secure Network Implementation Project"><h2>Secure Network Implementation with Firewall and Access Control (Cisco Packet Tracer)</h2></a>
            ...
            <div className="project">
                    <a href="#" target="_blank" rel="noreferrer" aria-label="Dynamic Routing Network Project"><img src={mock11} className="zoom" alt="thumbnail" width="100%"/></a>
                    <a href="#" target="_blank" rel="noreferrer" aria-label="Dynamic Routing Network Project"><h2>Dynamic Routing Network using OSPF (Cisco Packet Tracer)</h2></a>
